...
const Hero = () => {
  ...
  return (
    <div className="h-[1180px] bg-hero-pattern bg-cover bg-no-repeat bg-center bg-darkGray w-full">
      <div className="left-0 right-0 pl-10 pr-0 pt-[334px] pb-0 flex bg-hero-gray-pattern h-full bg-cover bg-no-repeat bg-center w-full">
        <div className="w-[1280px] mx-auto flex">
          ...
          <div>
            <img
              className="ml-[30%] animate-fade-in-right"
